...
<body>
    ...
    <main>
        ...
        <section class="grid">
            <?php foreach ($info_pagina['contenido'] as $juego): ?>
                <a>
                    <div class="card">
                        <iframe 
                            width="535" 
                            height="251" 
                            src="<?php echo htmlspecialchars($juego['video_src']); ?>" 
                            title="<?php echo htmlspecialchars($juego['titulo']); ?>" 
                            frameborder="0" 
                        ...
                        <p><?php echo htmlspecialchars($juego['texto']); ?></p>
                    </div>
                </a>
            <?php endforeach; ?>
        </section>
