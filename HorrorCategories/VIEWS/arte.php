...
$jsonData = file_get_contents(__DIR__ . '/../BACKEND/JSON/arte.json');
...
<body>
    ...
    <main>
        <h1 class="titulo" id="arriba"><?php echo htmlspecialchars($info_pagina['titulo']); ?></h1>

        <p class="LoPar">
            <?php echo htmlspecialchars($info_pagina['descripcion']); ?>
        </p>

        <section class="grid">
            <?php foreach ($info_pagina['obras'] as $obra): ?>
                <a href="<?php echo htmlspecialchars($obra['enlace']); ?>" target="_blank">
                    <div class="card">
                        <img src="<?php echo htmlspecialchars($obra['imagen']); ?>" alt="<?php echo htmlspecialchars($obra['alt']); ?>">
                        <h2>Obra: <?php echo htmlspecialchars($obra['titulo']); ?></h2>
                        <p><?php echo htmlspecialchars($obra['texto']); ?></p>
                    </div>
                </a>
            <?php endforeach; ?>
        </section>
